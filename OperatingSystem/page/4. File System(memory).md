...
![Alt text](Image/onmemory_superblock.png)
...
![Alt text](Image/onmemory_inode.png)
...
> ![Alt text](Image/mount_process(1).png)
> 
> #### 1. Cache the Mounted File System
>
> ![Alt text](Image/mount_process(2).png)
>
...
> 
> ![Alt text](Image/mount_process(3).png)
>
...
> 
> ![Alt text](Image/mount_process(4).png)
> 
> 연결 과정은 다음과 같다.<br>
>
...
root file system mount과정
system boot -> start_kernel()rest_init()kernel_init()prepare_namespace()mount_root(
	root file system을 찾아 system에 cache함
	root fs superblocks
	root fs inode
