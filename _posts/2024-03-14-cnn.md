...
>
> ![alt text](/assets/img/post/deeplearning_basic/convolution.png)
>
...
> #### Layer별 분석
>
> ![alt text](/assets/img/post/deeplearning_basic/alexnet_layer.png)
>
...
This means that for any two points $x_1, x_2$ in $C$, we have $\theta x_1 + (1-\theta)x_2 \in C$ for any $0 \leq \theta \leq 1$.
Extend this to $k$ points, that is, with $x_1, ..., x_k \in C$, and let $\theta_1, ... ,\theta_k \in \mathbb{R}$ satisfy $\theta_i \geq 0, \theta_1+ ... + \theta_n=1$. Show that $\theta_1 x_1 + ... + \theta_n x_n \in C$. 
