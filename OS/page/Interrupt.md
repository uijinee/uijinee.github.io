# Interrupt
## 1. Preview
![Alt text](Image/interrupt_preview.png)
...
> **Hardware Interrupt**
> 
> ![Alt text](Image/hardware_intterupt.png)
> 
...
> **동작 과정**
>
> ![Alt text](Image/systemcall_interrupt.png)
>
...
> ![Alt text](Image/systemcall_interrupt_1.png)
>
> 2. 해당 index에 새로운 system call의 이름을 쓴다.<br>
> ![Alt text](Image/systemcall_interrupt_2.png)
>
> 3. 적절한 위치에 새로운 system call을 정의한다.<br>
>   *(ex.`fs/read_write.c`)* <br>
> ![Alt text](Image/systemcall_interrupt_3.png)
>
...
>
> ![Alt text](Image/sys_ni_syscall.png)
> 
