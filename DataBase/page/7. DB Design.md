...
### 발생 가능한 문제점
![Alt text](Image/dbdesign_problem.png)
...
>
> ![Alt text](Image/spurious_tuple.png)
>
...
![Alt text](Image/fullfd_partialfd.png)
...
>> 
>> ![Alt text](Image/armstrong_axiom.png)
>>
>> **2. Additional Rules**
>> 
>> ![Alt text](Image/armstrong_axiom_additonal.png)
>
> ---
> **Attribute의 Closure**
>
...
![Alt text](Image/normalform_process.png)
...
> #### 3. 문제점
> 
> ![Alt text](Image/1nf_problem.png)
>
...
>
> 
> ![Alt text](Image/1nf_to_2nf.png)
>
> ---
> #### 3. 문제점
> 
> ![Alt text](Image/2nf_problem.png)
>
> - **Insertion Anomalies**<br>
...
>
> 
> ![Alt text](Image/2nf_to_3nf.png)
>
> ---
> #### 3. 문제점
> 
> ![Alt text](Image/3nf_problem(1).png)
>
> 위와 같이 나뉜 경우 발생하는 문제는 없다.<br>
> 하지만 아래와 같은 경우를 살펴보자.
>
> ![Alt text](Image/3nf_problem(2).png)
>
> (1) 복수의 후보키를 가짐<br>
...
> #### 3. 문제점
> 
> ![Alt text](Image/bcnf_problem.png)
>
> - **Insertion Anomalies**<br>
>   : 지도교수가 P4가 속한 학과가 기계과라는 사실을 넣을 때,<br>
>    Key조건에 의해 `{학번}`이라는 필요없는 정보도 넣어야 함
