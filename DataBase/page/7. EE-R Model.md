...
> **Specialization**
> 
> ![Alt text](Image/specialization.png)
>
...
> **Generalization**
> 
> ![Alt text](Image/generalization(1).png)
> 
> Bottom Up방식으로 SubClass의 SuperClass를 정의하는 과정이다.
>
> ![Alt text](Image/generalization(2).png)
> 
...
>
> ![Alt text](Image/shared_subclass.png)
>
> 이러한 경우는 최대한 피하는게 좋다. 
...
> **1. SubClass의 결정**
>
> ![Alt text](Image/constraint_type.png)
> 
...
> **2. 중복**
>
> ![Alt text](Image/disjoint_overlapping.png)
> 
> - **DisJoint**<br>
...
>
> ![Alt text](Image/completeness_constraint.png)
> 
> - Total<br>
...
> 
> ![Alt text](Image/uniontype.png)
> 
> 하지만 이러한 경우는 별로 존재하지 않기 때문에 1실제로는 거의 사용하지 않는다.
>


![Alt text](Image/eerdiagram.png)
