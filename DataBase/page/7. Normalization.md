...
>
>![Alt text](Image/3nf_to_bcnf.png)
>
...
> #### Case2
>
> ![Alt text](Image/db_normalization_example(3).png)
> 
> - **Key**<br>
>   Primary Key: $\{A, B\} \rarr \{A, B, C, D, E, F, G, H, I, J\}$
> - **To 2NF**<br>
>   ![Alt text](Image/db_normalization_2nf(3).png)<br>
>   : $R_1=\{\underline{A, B}, C\}$<br>
>   : $R_2=\{\underline{A}, D, E, I, J\}$, (5번 FD는 1번 FD에 의해 결정되므로 1번 FD에 통합)<br>
>   : $R_3=\{\underline{B}, F, G, H\}$, (4번 FD는 3번 FD에 의해 결정되므로 3번 FD에 통합)
> - **To 3NF**<br>
>   ![Alt text](Image/db_normalization_3nf(3).png)<br>
>   : $R_1=\{\underline{A, B}, C\}$<br>
>   : $R_2=\{\underline{A}, D, E\}$<br>
...
> #### Case3
>
> ![Alt text](Image/db_normalization_example(2).png)
>
> - **Key**<br>
...
> - **To 2NF**<br>
>   ![Alt text](Image/db_normalization_2nf(2).png)<br>
>   : $R_1=\{\underline{id}, Country\_name, Lot\#, Area, Price\}$<br>
>   : $R_2=\{\underline{Country\_name}, Tax\_rate\}$<br>
> - **To 3NF**<br>
>   ![Alt text](Image/db_normalization_3nf(2).png)<br>
...
> #### Case4
> 
> ![Alt text](Image/db_normalization_example(4).png)
> 
> - **Key**<br>
>   Primary Key: $\{Title, Author\} \rarr \{Title, Author, Type, Price, Author_affil, Publisher\}$
> - **To 2NF**<br>
>   ![Alt text](Image/db_normalization_2nf(4).png)<br>
...
> - **To 3NF**<br>
>   ![Alt text](Image/db_normalization_3nf(4).png)<br>
